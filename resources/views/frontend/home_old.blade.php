...
<section class="hero-premium py-5" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; position: relative; overflow: hidden;">
    <div class="position-absolute" style="top: -50%; right: -50%; width: 500px; height: 500px; background: rgba(255,255,255,0.1); border-radius: 50%; animation: float 8s ease-in-out infinite;"></div>
    <div class="position-absolute" style="bottom: -30%; left: -30%; width: 400px; height: 400px; background: rgba(255,255,255,0.08); border-radius: 50%; animation: float 10s ease-in-out infinite reverse;"></div>

    <div class="container position-relative" style="z-index: 2;">
        <div class="row align-items-center py-5">
            <div class="col-lg-6">
                <h1 class="display-4 fw-bold mb-4">Bienvenue chez KdTech</h1>
                <p class="lead mb-4 fs-5">Votre partenaire de confiance pour l'électronique et les réparations à Lomé. Produits de qualité, service rapide et expertise garantie.</p>
                <div class="d-flex gap-3 flex-wrap">
                    <a href="{{ route('products.index') }}" class="btn btn-light btn-lg px-4 py-3 fw-semibold">
                        <i class="fas fa-shopping-bag me-2"></i>Découvrir Produits
                    </a>
                    <a href="{{ route('repairs.index') }}" class="btn btn-outline-light btn-lg px-4 py-3 fw-semibold">
                        <i class="fas fa-tools me-2"></i>Service Réparation
                    </a>
                </div>
            </div>
            <div class="col-lg-6 text-center">
                <div class="position-relative">
                    <i class="fas fa-laptop-code" style="font-size: 10rem; color: rgba(255,255,255,0.2);"></i>
                </div>
            </div>
        </div>
    </div>
